...
CREATE TABLE `admin`  (
  ...
  `role` varchar(1) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '角色(0管理员，1部门管理员，2员工)',
...
CREATE TABLE `student`  (
  ...
  `cardId` varchar(18) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '身份证号',
  `sex` varchar(2) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '性别',
  `role` varchar(1) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT '2' COMMENT '角色(0管理员，1部门管理员，2员工)',
  PRIMARY KEY (`studentId`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 20225009 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '员工信息表' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 20081006 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '部门管理员信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `teacher` VALUES (20081003, '李四', '计算机学院', '男', '13333333333', NULL, '123456', '441111111111111111', '部门管理员', '1');
...
CREATE TABLE `training_course`  (
  ...
  `fileName` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '课件文件名',
  `fileUrl` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '课件访问地址',
  `fileType` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '课件类型(文档/视频/音频)',
  `department` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '部门',
  `position` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '岗位',
  `description` varchar(500) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '课程简介',
  `creatorId` int DEFAULT NULL COMMENT '创建人ID',
  `createTime` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '培训课程表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `training_plan`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `planName` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '培训计划名称',
  `courseId` bigint NOT NULL COMMENT '课程ID',
  `department` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '分配部门',
  `position` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '分配岗位',
  `startTime` datetime DEFAULT NULL COMMENT '开始时间',
  `endTime` datetime DEFAULT NULL COMMENT '结束时间',
  `creatorId` int DEFAULT NULL COMMENT '创建人ID',
  `createTime` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '培训计划表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `training_record`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `planId` bigint NOT NULL COMMENT '培训计划ID',
  `courseId` bigint NOT NULL COMMENT '课程ID',
  `employeeId` int NOT NULL COMMENT '员工ID',
  `learningDuration` int DEFAULT 0 COMMENT '累计学习时长(分钟)',
  `completionPercent` int DEFAULT 0 COMMENT '课程完成率',
  `completed` tinyint DEFAULT 0 COMMENT '是否完成(0否1是)',
  `lastStudyTime` datetime DEFAULT NULL COMMENT '最近学习时间',
  `createTime` datetime DEFAULT NULL COMMENT '创建时间',
  `updateTime` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `uk_plan_employee` (`planId`,`employeeId`)
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '员工培训学习记录表' ROW_FORMAT = Dynamic;
