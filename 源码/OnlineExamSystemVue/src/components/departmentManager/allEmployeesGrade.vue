...
<template>
  <div class="all">
    ...
    <el-table :data="pagination.records" border>
      ...
      <el-table-column prop="institute" label="所属部门" width="220"></el-table-column>
      <el-table-column prop="major" label="岗位名称" width="240"></el-table-column>
      <el-table-column prop="grade" label="岗位等级" width="200"></el-table-column>
      <el-table-column prop="clazz" label="电子邮箱" width="120"></el-table-column>
