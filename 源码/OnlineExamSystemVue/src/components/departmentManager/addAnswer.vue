...
<template>
  <div class="exam">
    <el-table :data="pagination.records" border>
      ...
      <el-table-column prop="major" label="岗位名称" width="200"></el-table-column>
      <el-table-column prop="grade" label="岗位等级" width="100"></el-table-column>
      ...
      <el-table-column fixed="right" label="操作" width="180">
        <template slot-scope="scope">
          <el-button @click="add(scope.row.paperId,scope.row.source)" type="primary"> 录入题目</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
